...
Refer to the [test-contracts](projects/test-contracts/README.md) folder for overview of working with smart contracts, [projects/test-frontend](projects/test-frontend/README.md) for overview of the React project and the [projects/test-frontend/contracts](projects/test-frontend/src/contracts/README.md) folder for README on adding new smart contracts from backend as application clients on your frontend. The templates provided in these folders will help you get started.
When you compile and generate smart contract artifacts, your frontend component will automatically generate typescript application clients from smart contract artifacts and move them to `frontend/src/contracts` folder, see [`generate:app-clients` in package.json](projects/test-frontend/package.json). Afterwards, you are free to import and use them in your frontend application.

The frontend starter also provides an example of interactions with your HelloWorldClient in [`AppCalls.tsx`](projects/test-frontend/src/components/AppCalls.tsx) component by default.
